        ...
        <div className="card-body items-center">
          ...
          <div className="mt-4 flex flex-col gap-3">
            <label className="input input-bordered flex items-center gap-2">
              ...
              <input type="text" className="grow" placeholder="Email" onChange={(e: FormEvent<HTMLInputElement>) => {
            ...
            <label className="input input-bordered flex items-center gap-2">
              ...
              <input type="password" className="grow" placeholder="Password" onChange={(e: FormEvent<HTMLInputElement>) => {
                const newValue = e.currentTarget.value;
